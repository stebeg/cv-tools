...
import io.github.stebeg.comicvine.volume.VolumeCredit;
...
public class PublisherRetrieverTest {
  ...
  @Test
  public void testGetPublisherById_NotFoundResponse() throws Exception {
    final long publisherId = 9999999L;
    final GetPublisherByIdRequest request = new GetPublisherByIdRequest("12345", publisherId);
