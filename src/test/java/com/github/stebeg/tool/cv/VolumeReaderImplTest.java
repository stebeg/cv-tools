...
public class VolumeReaderImplTest {
    ...
    public void testSearchVolumes() throws IOException {
        ...
        expResultVolume1.setPublisher(new Publisher(10, "DC Comics"));
        ...
        expResultVolume2.setPublisher(new Publisher(10, "DC Comics"));
        ...
        assertEquals(expResultVolume1.getImage().getOriginalUrl(), resultVolume1.getImage().getOriginalUrl());
        ...
        assertEquals(expResultVolume2.getImage().getOriginalUrl(), resultVolume2.getImage().getOriginalUrl());
    ...
    public void testGetVolume() throws IOException {
        ...
        expResultVolume.setPublisher(new Publisher(10, "DC Comics"));
        expResultVolume.setImage(new Image(
                "https://comicvine.gamespot.com/api/image/original/4457-2013-4869-1-green-lantern.jpg",
                "https://comicvine.gamespot.com/api/image/scale_avatar/4457-2013-4869-1-green-lantern.jpg"));
        final VolumeGetResult expResult = new VolumeGetResult(1, expResultVolume);

        final URL url = getClass().getResource("/volume-get-example.json");
