...
/**
 * An API request for retrieving a list of locations.
 */
public class GetLocationListRequest extends AbstractApiRequest {

  /**
   * The URL fragment for the locations API.
   */
  public static final String API_URL_FRAGMENT = "/locations";

  /**
   * Creates a new API request for retrieving a list of locations.
   *
   ...
   *               </ul>
   */
  public GetLocationListRequest(String apiKey, String filter) {
    super(apiKey);
   ...
   * @return This request.
   */
  public GetLocationListRequest withSort(final String sort) {
   ...
   * @return This request.
   */
  public GetLocationListRequest withLimit(int limit) {
   ...
   * @return This request.
   */
  public GetLocationListRequest withOffset(int offset) {
   ...
   * @return This request.
   */
  public GetLocationListRequest withFieldNames(final List<String> fieldNames) {
