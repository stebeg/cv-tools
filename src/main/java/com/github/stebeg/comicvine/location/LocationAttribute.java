...
/**
 * Contains the names of the attributes of a location from the Comicvine API.
 */
public class LocationAttribute {

  /**
   * The name of the attribute for the location's unique ID.
   */
  public static final String ID = "id";
  /**
   * The name of the attribute for the location's name.
   */
