...
/**
 * An API request for retrieving a list of teams.
 */
public class GetTeamListRequest extends AbstractApiRequest {

  /**
   * The URL fragment for the teams API.
   */
  public static final String API_URL_FRAGMENT = "/teams";

  /**
   * Creates a new API request for retrieving a list of teams.
   *
   ...
   *               </ul>
   */
  public GetTeamListRequest(String apiKey, String filter) {
    super(apiKey);
   ...
   * @return This request.
   */
  public GetTeamListRequest withSort(final String sort) {
   ...
   * @return This request.
   */
  public GetTeamListRequest withLimit(int limit) {
   ...
   * @return This request.
   */
  public GetTeamListRequest withOffset(int offset) {
   ...
   * @return This request.
   */
  public GetTeamListRequest withFieldNames(final List<String> fieldNames) {
