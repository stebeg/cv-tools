...
public class GetIssueListRequest extends AbstractApiRequest {
  ...
  /**
   * The URL fragment for the issues API.
   */
  public static final String API_URL_FRAGMENT = "/issues";
   ...
   * @return This request.
   */
  public GetIssueListRequest withFields(final List<String> fieldNames) {
