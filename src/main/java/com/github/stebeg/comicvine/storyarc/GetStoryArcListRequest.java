...
/**
 * An API request for retrieving a list of story arcs.
 */
public class GetStoryArcListRequest extends AbstractApiRequest {

  /**
   * The URL fragment for the story arcs API.
   */
  public static final String API_URL_FRAGMENT = "/story_arcs";

  /**
   * Creates a new API request for retrieving a list of story arcs.
   *
   ...
   *               </ul>
   */
  public GetStoryArcListRequest(String apiKey, String filter) {
    super(apiKey);
   ...
   * @return This request.
   */
  public GetStoryArcListRequest withSort(final String sort) {
   ...
   * @return This request.
   */
  public GetStoryArcListRequest withLimit(int limit) {
   ...
   * @return This request.
   */
  public GetStoryArcListRequest withOffset(int offset) {
