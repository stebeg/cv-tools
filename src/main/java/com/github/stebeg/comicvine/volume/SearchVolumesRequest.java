...
/**
 * An implementation of {@link AbstractApiRequest} for searching volumes in the Comicvine API.
 */
public class SearchVolumesRequest extends AbstractApiRequest {

  public static final String API_URL_FRAGMENT = "/search/";
  public static final String RESOURCES_PARAMETER_VALUE = "volume";

  /**
   * Creates a new request for searching volumes in the Comicvine API.
   *
   * @param apiKey     The API key for accessing the Comicvine API.
   * @param searchText The text to search for.
   */
  public SearchVolumesRequest(String apiKey, String searchText) {
    super(apiKey);
   ...
   * @return This request.
   */
  public SearchVolumesRequest withSort(final String sort) {
   ...
   * @return This request.
   */
  public SearchVolumesRequest withLimit(int limit) {
   ...
   * @return This request.
   */
  public SearchVolumesRequest withOffset(int offset) {
   ...
   * @return This request.
   */
  public SearchVolumesRequest withFieldNames(final List<String> fieldNames) {
