...
/**
 * An API request for retrieving a list of people.
 */
public class GetPersonListRequest extends AbstractApiRequest {

  /**
   * The URL fragment for the people API.
   */
  public static final String API_URL_FRAGMENT = "/people";

  /**
   * Creates a new API request for retrieving a list of people.
   *
   ...
   *               </ul>
   */
  public GetPersonListRequest(String apiKey, String filter) {
    super(apiKey);
   ...
   * @return This request.
   */
  public GetPersonListRequest withSort(final String sort) {
   ...
   * @return This request.
   */
  public GetPersonListRequest withLimit(int limit) {
   ...
   * @return This request.
   */
  public GetPersonListRequest withOffset(int offset) {
   ...
   * @return This request.
   */
  public GetPersonListRequest withFieldNames(final List<String> fieldNames) {
