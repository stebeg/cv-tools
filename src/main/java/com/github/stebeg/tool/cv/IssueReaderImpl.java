...
/**
 * An implementation for retrieving issues from a comic book series from the
 * Comicvine API.
 * 
...
class IssueReaderImpl implements IssueReader {
    ...
    /**
     * Creates a new instance of the implementation for retrieving issues from a
     * comic book series from the Comicvine API.
     *
