...
class UrlBuilderImpl implements UrlBuilder {
    ...
    /**
     * The URL fragment appended to {@link UrlBuilderImpl#API_BASE_URL} to build
     * the URL for searching volumes via Comicvine API.
     */
    static final String API_SEARCH_URL_FRAGMENT = "searchVolumes/";

    /**
     * The URL fragment appended to {@link UrlBuilderImpl#API_BASE_URL} to build
     * the URL for retrieving volume information from the Comicvine API.
     */
    static final String API_VOLUME_URL_FRAGMENT = "volume/";

    /**
     * The URL fragment appended to {@link UrlBuilderImpl#API_BASE_URL} to build
     * the URL for retrieving issue information for a volume from the Comicvine
     * API.
     */
    ...
    /**
     * The URL fragment appended to {@link UrlBuilderImpl#API_BASE_URL} to build
     * the URL for retrieving issue information from the Comicvine API.
     */
    static final String API_ISSUE_URL_FRAGMENT = "issue/";

    /**
     * For retrieving data from the Comicvine API, a parameter is needed to
     * identify the software. This is the name of this parameter.
     */
    static final String CLIENT_PARAMETER_NAME = "client";

    /**
     * For retrieving data from the Comicvine API, a parameter is needed to
     * identify the software. This is the value of this parameter.
     */
    static final String CLIENT_PARAMETER_VALUE = "cv-tools";

    /**
     * Creates a new instance of the implementation for building Comicvine API
     * URLs.
     */
    UrlBuilderImpl() {
    }
    ...
    public URL buildVolumeSearchUrl(final Map<String, String> parameter) throws IOException {
        try {
            final URIBuilder uriBuilder = new URIBuilder(API_BASE_URL.concat(API_SEARCH_URL_FRAGMENT));
