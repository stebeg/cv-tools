...
public interface VolumeReader {
     ...
     *
     * @param apiKey An API key needed for retrieving information from the
     * Comicvine API.
     * @param searchText The name of the volumes to be search. It can also be a
     * fragment of the name.
     * @return The search result containing the volumes.
     * @throws IOException When the communication with the Comicvine API or
     * reading the information fails.
     */
