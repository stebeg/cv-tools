...
/**
 * An implementation of {@link AbstractApiRequest} for searching people in the Comicvine API.
 */
public class SearchPeopleRequest extends AbstractApiRequest {

  private static final String API_URL_FRAGMENT = "/search/";
  private static final String RESOURCES_PARAMETER_VALUE = "person";

  /**
   * Creates a new request for searching people in the Comicvine API.
   *
   * @param apiKey    The API key for accessing the Comicvine API.
   * @param searchText The text to search for.
   */
  public SearchPeopleRequest(String apiKey, String searchText) {
    super(apiKey);
   ...
   * @return This request.
   */
  public SearchPeopleRequest withSort(final String sort) {
   ...
   * @return This request.
   */
  public SearchPeopleRequest withLimit(int limit) {
   ...
   * @return This request.
   */
  public SearchPeopleRequest withOffset(int offset) {
