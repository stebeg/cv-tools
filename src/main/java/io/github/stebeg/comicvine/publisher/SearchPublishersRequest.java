...
/**
 * An implementation of {@link AbstractApiRequest} for searching publishers in the Comicvine API.
 */
public class SearchPublishersRequest extends AbstractApiRequest {

  private static final String API_URL_FRAGMENT = "/search/";
  private static final String RESOURCES_PARAMETER_VALUE = "publisher";

  /**
   * Creates a new request for searching publishers in the Comicvine API.
   *
   * @param apiKey    The API key for accessing the Comicvine API.
   * @param searchText The text to search for.
   */
  public SearchPublishersRequest(String apiKey, String searchText) {
    super(apiKey);
   ...
   * @return This request.
   */
  public SearchPublishersRequest withSort(final String sort) {
   ...
   * @return This request.
   */
  public SearchPublishersRequest withLimit(int limit) {
   ...
   * @return This request.
   */
  public SearchPublishersRequest withOffset(int offset) {
